...
void statusbar_init(void)
{
    ...
    /* create start image */
    logo_image  = rtgui_image_create(RESOURCE_PATH"/SD/LOGO.HDC", RT_FALSE);
    back_image  = rtgui_image_create(RESOURCE_PATH"/SD/BACK.HDC", RT_FALSE);
    linkup_image  = rtgui_image_create(RESOURCE_PATH"/SD/LINKUP.HDC", RT_FALSE);
    linkdown_image  = rtgui_image_create(RESOURCE_PATH"/SD/LINKDOWN.HDC", RT_FALSE);
