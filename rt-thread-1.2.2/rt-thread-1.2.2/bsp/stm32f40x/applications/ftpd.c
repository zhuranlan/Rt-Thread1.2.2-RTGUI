...
#define FTP_PORT			21
#define FTP_SRV_ROOT		"/"
#define FTP_MAX_CONNECTION	5
#define FTP_USER			"ran"
#define FTP_PASSWORD		"ran"
#define FTP_WELCOME_MSG		"220-= welcome on RT-Thread FTP server =-\r\n220 \r\n"
#define FTP_BUFFER_SIZE		1024*2//1024*10
...
struct ftp_session* ftp_new_session()
{
 ...
 // rt_kprintf("ftp_session:%d \n",sizeof(struct ftp_session));
...
//char buffer[FTP_BUFFER_SIZE] __attribute__((at(0X10000000+1024*56)))= {0};//将FTP的缓冲放入到CCRAM中
